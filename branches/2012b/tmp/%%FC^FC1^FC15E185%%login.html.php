<?php /* Smarty version 2.6.13, created on 2012-06-04 17:01:29
...
<link rel="stylesheet" href="css/marlboro.css" media="screen,screen" type="text/css" title="default"/>
            </HEAD>
    ...
    <div class="content">
      ...
      <div class="formLanding">
        <div id="divLoginBox" class="loginBox">
          ...
          <div class="row">
            <input name="txtUserName" type="text" maxlength="60" id="txtUserName" value="username" class="lpInput" />
          </div>
          <div class="row">
            <input name="txtPassword" type="password" maxlength="12" id="txtPassword" value="password" class="lpInput" />
			<input type="hidden" name="goLogin" value="1" />
          </div>
          <div class="smSubmit"><a  id="lnkBtnSubmit" onCLick="document.getElementById('loginForm').submit();">Masuk</a></div>
          <p class="error"><span id="lblError"></span></p>
          </form>
		  <div class="forgottenpassword"><a style="text-transform:capitalize;" id="lnkBtnForgotPwd" href="javascript:__doPostBack('lnkBtnForgotPwd','')">Forget Password?</a></div>
        ...
        <div id="divRegisterBox" class="registerBox">
          ...
          <div class="smSubmit"><a style="width:211px; text-transform:capitalize; text-align:right;"  onclick="pageTracker._trackEvent('Register', 'Click');" id="lnkBtnRegister" href="javascript:__doPostBack('lnkBtnRegister','')">Not Yet Registered? <strong style="color:#000">sign up</strong></a></div>
    ...
    <div class="content">
      ...
      <div class="formLanding">
        <div id="divLoginBox" class="loginBox">
		  ...
		  <div class="forgottenpassword"><a id="lnkBtnForgotPwd" href="javascript:__doPostBack('lnkBtnForgotPwd','')">Lupa Password/Username?</a></div>
          <div class="loginBoxClose"></div>
        </div>
        <div id="divRegisterBox" class="registerBox">
          <div class="registerBoxTitle">
          ...
          <div class="smSubmit"><a onclick="pageTracker._trackEvent('Register', 'Click');" id="lnkBtnRegister" href="javascript:__doPostBack('lnkBtnRegister','')">Daftar</a></div>
          <div class="registerBoxClose"></div>
        </div>
        <div class="formLandingClose"></div>
      </div>
