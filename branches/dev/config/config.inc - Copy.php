...
define('BASEURL','http://localhost/redrush/branches/2012/public_html/');        //set BASEURL frontend
define('BASEURL_ADMIN','https://admstaging.marlboro.co.id/');        //set BASEURL admin
define('APP_PATH',$APP_PATH);
define('SCHEMA_CONNECTION','connection_2012');
define('SCHEMA_CODE','connection_code_2012');
//set database
...
if($CONFIG['DEVELOPMENT']){
        ...
        $CONFIG['DATABASE'][0]['DATABASE']         = "connection_2012";
        error_reporting(0);
}else{
...
$CONFIG['MOP_URL_LOGIN'] = 'http://localhost/redrush/branches/dev/public_html/login.php';

$WIN_PENALTY = array(0.05,0.1,0.2);
// $GAME_API = "http://preview.kanadigital.com/redrush/api/";
$GAME_API = "http://localhost/redrush/branches/dev/api/";
